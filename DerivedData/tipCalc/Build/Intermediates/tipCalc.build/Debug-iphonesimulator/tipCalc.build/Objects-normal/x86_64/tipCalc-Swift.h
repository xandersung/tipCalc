...
SWIFT_CLASS("_TtC7tipCalc11AppDelegate")
...
SWIFT_CLASS("_TtC7tipCalc14ViewController")
@interface ViewController : UIViewController
@property (nonatomic, weak) IBOutlet UITextField * _Null_unspecified billTextField;
...
- (IBAction)calculateTipButtonTapped:(id _Nonnull)sender;
